<script lang="ts">
  ...
  import { export_download_path, ExportRecord, ExportsBackendDataSource } from "@/data/model/sync/exports/record";
  ...
  let exports = $state(syncJob.exports);
