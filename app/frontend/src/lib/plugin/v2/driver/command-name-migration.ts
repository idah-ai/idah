...
export const COMMAND_NAME_RENAMES: Record<string, string[]> = {
  ...
  "annotation.polygon.add_point": ["idah-video:annotation.polygon.add-point", "idah-image:annotation.polygon.add-point"],
  "annotation.split": ["idah-video:annotation.split"],
  "annotation.toggle_category_editability": ["idah-video:annotation.category.toggle-editability", "idah-image:annotation.category.toggle-editability"],
  "annotation.toggle_category_visibility": ["idah-video:annotation.category.toggle-visibility", "idah-image:annotation.category.toggle-visibility"],
  "annotation.toggle_category_visibility_solo": ["idah-video:annotation.category.toggle-visibility-solo"],
  "annotation.toggle_editability_all": ["idah-video:annotation.toggle-editability-all", "idah-image:annotation.toggle-editability-all"],
  ...
  "annotation.toggle_visibility_all": ["idah-video:annotation.toggle-visibility-all", "idah-image:annotation.toggle-visibility-all"],
