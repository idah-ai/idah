<script lang="ts">
  ...
  //
  // Shows all keyboard shortcuts available in the current mode and lets the
  // user remap them. Toggled via Ctrl+Space (handled by the parent, we just
  // react to `open`).
  // -----------------------------------------------------------------------
  ...
  import type { IAccountSettingsDriverV2, ICommandDriverV2 } from "$idah/v2/types";
