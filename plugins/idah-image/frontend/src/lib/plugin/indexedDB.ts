...
export class AnnotationsIndexedDB {
  ...
  upsertAnnotations(annotations: ImageAnnotationObject[]): Promise<void> {
  ...
  get(store_name: string, key: string): Promise<ImageAnnotationObject> {
  ...
  getGroupAnnotations(groupId: string): Promise<ImageAnnotationObject[]> {
  ...
  addKeyFrame(annotation: ImageAnnotationObject, keyFrame: ImageFrameSelection) {
    const transaction = this.db.transaction(["annotations", "keyframes"], "readwrite");
    ...
    return new Promise<void>((resolve, reject) => {
      request.onsuccess = () => {
        ...
        Arequest.onsuccess = () => {
          const annotation = Arequest.result as ImageAnnotationObject;
  ...
  deleteKeyFrame(annotation: ImageAnnotationObject, frame: number): Promise<void> {
  ...
  getAllStartingWith(key: string, value: string) {
    return new Promise<ImageAnnotationObject[]>((resolve, reject) => {
      ...
      const result: ImageAnnotationObject[] = [];
      request.onsuccess = () => {
