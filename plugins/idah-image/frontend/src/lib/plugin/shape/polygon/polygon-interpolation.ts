import { circularDistance, distance, midpoint, projectPointOnSegment } from "$lib/plugin/shape/geometry-utils";

import type { ImageFrameSelection, InterpolatedVertex, Point } from "$lib/context/image-annotation-context";
...
export function interpolatePolygonAtFrame(
  frameStartPoly: ImageFrameSelection,
  frameEndPoly: ImageFrameSelection,
