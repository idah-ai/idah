...
//
// NOTE: SVG-vs-mask click-priority is still hardcoded mask-first/SVG-fallback
// in ShapesContainer.svelte and needs a dedicated pass to make it config-driven.
// ---------------------------------------------------------------------------
