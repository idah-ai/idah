...
viewport   [{viewport.workspace.viewportSize[0].toFixed(3)}, {viewport.workspace.viewportSize[1].toFixed(
        3,
      )}] → [{viewport.workspace.viewportSize[2].toFixed(3)}, {viewport.workspace.viewportSize[3].toFixed(3)}]
transform  translate({viewport.workspace.transform.translate[0].toFixed(
        1,
