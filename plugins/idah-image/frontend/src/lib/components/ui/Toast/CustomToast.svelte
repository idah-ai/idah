<script lang="ts">
  ...
  import type { CustomToastOptions } from "$lib/components/ui/Toast/index.svelte";
...
<div class="flex text-sm">
  ...
  {#if dismissable}
    <button
      class={cn(
        "absolute -top-2 -right-2 flex size-5 cursor-pointer items-center justify-center rounded-full border",
        {
