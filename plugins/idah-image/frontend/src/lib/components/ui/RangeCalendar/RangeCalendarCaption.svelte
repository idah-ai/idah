<script lang="ts">
	...
	import type RangeCalendar from "./RangeCalendar.svelte";
	import RangeCalendarMonthSelect from "./RangeCalendarMonthSelect.svelte";
	import RangeCalendarYearSelect from "./RangeCalendarYearSelect.svelte";
