...
export class AnnotationsIndexedDB {
   ...
   */
  async getAllByIndex(key: string, value?: string): Promise<VideoAnnotationObject[]> {
    return new Promise<VideoAnnotationObject[]>((resolve, reject) => {
   ...
   */
  async putAnnotation(annotation: VideoAnnotationObject): Promise<void> {
   ...
   */
  async putAnnotations(annotations: VideoAnnotationObject[]): Promise<void> {
    const transaction = this.db.transaction(["annotations", "keyframes"], "readwrite");
    const astore = transaction.objectStore("annotations");
    const kstore = transaction.objectStore("keyframes");
   ...
   */
  async getKeyFrames(annotation_id: string): Promise<VideoFrameSelection[]> {
    return new Promise<VideoFrameSelection[]>((resolve, reject) => {
   ...
   */
  async updateAll(updateFn: (annotation: VideoAnnotationObject) => VideoAnnotationObject): Promise<void> {
