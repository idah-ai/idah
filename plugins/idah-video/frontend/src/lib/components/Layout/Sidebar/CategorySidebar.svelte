<script lang="ts">
  ...
  import AnnotationCountBadge from "$lib/components/Layout/Sidebar/AnnotationCountBadge.svelte";
  import AnnotationGroupNode from "$lib/components/Layout/Sidebar/Category/AnnotationGroupNode.svelte";
